...
class Ui_Mouse_Positioning_Interface(object):
    def setupUi(self, Mouse_Positioning_Interface):
        ...
        self.gridLayout_9 = QtWidgets.QGridLayout(self.GroupCoordinates)
        ...
        self.gridLayout_9.addWidget(self.SS_IsoCenter, 0, 0, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.SS_PlanImage, 0, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.label_8, 0, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.SS_TreatImage, 0, 4, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.label_11, 0, 5, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.SS_RegApproved, 0, 6, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.label_12, 0, 7, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.SS_StageSet, 0, 8, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem, 0, 9, 1, 1)
        ...
        self.Graybar_Overlay = matplotlibWidget(self.groupBox_20)
        self.Graybar_Overlay.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Graybar_Overlay.sizePolicy().hasHeightForWidth())
        self.Graybar_Overlay.setSizePolicy(sizePolicy)
        self.Graybar_Overlay.setMinimumSize(QtCore.QSize(0, 80))
        self.Graybar_Overlay.setMaximumSize(QtCore.QSize(1000000, 100))
        self.Graybar_Overlay.setObjectName("Graybar_Overlay")
        self.gridLayout_10.addWidget(self.Graybar_Overlay, 0, 0, 1, 2)
        ...
        self.gridLayout_10.addWidget(self.Display_Fusion, 1, 0, 1, 2)
        ...
        self.gridLayout_48.addItem(spacerItem4, 1, 0, 1, 1)
